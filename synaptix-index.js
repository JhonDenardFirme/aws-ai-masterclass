 ...
 *
 * DO NOT import in educational artifacts.
 * Those use synaptix-runtime.js exclusively.
 */
...
var snxIndex = {
   ...
   *   title: 'string',
   *   description: 'string',
   *   tag: 'Foundations' | 'Specializations' | 'Techniques' | 'Advanced',
   *   color: 'orange' | 'sky' | 'cyan' | 'purple' | 'green' | 'amber',
   *   sections: 6,
   *   duration: '60 min',
   *   reviewer: '../modules/01_claude-masterclass-reviewer.html',
   *   compact:  '../compact/01_claude-masterclass-compact.html',
   *   tree:     '../trees/01_claude-masterclass-tree.html',
   *   quiz:     '../quizzes/01_claude-masterclass-quiz.html',
   *   recall:   '../recalls/01_claude-masterclass-recall.html'
   * }
   */
   ...
   * @param {string} tag — 'all' | 'Foundations' | 'Specializations' | etc.
   */
...
/* ════════════════════════════════════════════
   ...
   NOTE: localStorage is only available for index/collection pages.
   It must NOT be used in educational artifacts.
*/
...
var snxProgress = {
   ...
   * @param {string} type — 'reviewer' | 'quiz' | 'recall' | 'compact' | 'tree'
   */
